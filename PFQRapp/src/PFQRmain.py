...
#入力1 格納するURL
contents = "www.kobe-u.ac.jp"
#入力2 QRコード上に配置する画像のパス
picturepath = "logo_kobeuniv.png"
...
picture_origin = cv2.imread(picturepath,cv2.IMREAD_UNCHANGED)
...
cv2.imwrite("pictureinQR_bin.bmp", qrimage_bin)
...
backimage = cv2.imread("pattern1_backimage.bmp")
...
cv2.imwrite("PFQRcode.bmp", Hiddenqr) #出力1
cv2.imwrite("PFQRcode_nomalFP.bmp", Hiddenqr_nomalFP) #出力2
cv2.imwrite("pictureQRcode.bmp", nonsytematicQR) #出力3